...
function PhoneBookForm({ addEntryToPhoneBook }) {
    const [inputs, setInputs] = useState({
        userFirstname: addEntryToPhoneBook.userFirstname,
        userLastname: addEntryToPhoneBook.userLastname,
        userPhone: addEntryToPhoneBook.userPhone
    });
...
function Application(props) {
    ...
    return (
        <section>
            <PhoneBookForm addEntryToPhoneBook={defaultPhoneBookEntry} />
            <InformationTable/>
        </section>
    );
}
