...
app.post('/save',(request,reply)=>{
    ...
    userInput.firstname = body.firstname.substring(body.firstname.indexOf("<b>") + 3, body.firstname.indexOf("</b>"));
    userInput.lastname = body.lastname.substring(body.lastname.indexOf('">') + 2, body.lastname.indexOf("</a>"));
